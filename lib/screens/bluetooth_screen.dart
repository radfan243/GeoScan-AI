...
class _BluetoothScreenState extends State<BluetoothScreen> {
  // ============================================================
  // GeoScan AI - Bluetooth Screen
  //
  // تستخدم نفس BluetoothService المشتركة مع ScanScreen.
  // لا يتم إنشاء اتصال Bluetooth جديد هنا.
  // ============================================================
  ...
  void initState() {
    ...
    _connectionSubscription =
      ...
      onError: (error) {
        debugPrint(
          'Bluetooth connection stream error: $error',
        );
      },
    );
  }
  ...
  void dispose() {
    // مهم:
    // لا نعمل dispose للخدمة لأنها مشتركة
    // مع ScanScreen.
  ...
  Future<void> _startScan() async {
    ...
    try {
      ...
      debugPrint(
        'GeoScan Bluetooth scan error: $e',
      );
  ...
  Future<void> _connect(
    ...
    try {
      ...
      if (success) {
        // BluetoothService الحالية مسؤولة عن
        // اكتشاف الخدمة وتشغيل Notifications.
        // لا نستدعي startNotifications مرة ثانية.
      ...
      debugPrint(
        'GeoScan Bluetooth connect error: $e',
      );
  ...
  Future<void> _disconnect() async {
    try {
      ...
      debugPrint(
        'GeoScan Bluetooth disconnect error: $e',
      );
    }
